...
describe("push", function() {
  it("appends node and increments length", function() {
    ...
    let lst2 = new LinkedList([0]);

    lst2.push(1);
    expect(lst2.length).toBe(2);
    expect(lst2.head.val).toBe(0);
    expect(lst2.head.next.val).toBe(1);
    expect(lst2.tail.val).toBe(1);
  });
});
...
describe("unshift", function() {
  it("adds node at start and increments length", function() {
    ...
    lst2.unshift(1);
    expect(lst2.length).toBe(2);
    expect(lst2.head.val).toBe(1);
    expect(lst2.head.next.val).toBe(0);
    expect(lst2.tail.val).toBe(0);
  });
});
...
describe("setAt", function() {
  it("sets val at index", function() {
    ...
    let lst2 = new LinkedList([1, 5, 3]);

    lst2.setAt(1, 2);
    expect(lst2.head.val).toBe(1);
    expect(lst2.head.next.val).toBe(2);
    expect(lst2.tail.val).toBe(3);
  });
});
...
describe("removeAt", function() {
  it("removes from 1-item list", function() {
    ...
    let lst2 = new LinkedList([5, 10, 15, 20]);
    expect(lst2.removeAt(2)).toBe(15)
    expect(lst2.length).toBe(3);
    expect(lst2.head.val).toBe(5);
    expect(lst2.head.next.val).toBe(10);
    expect(lst2.tail.val).toBe(20);
  });
});
...
describe("average", function() {
  ...
  it("throws an error if non integer values are present in list", function() {
    let lst = new LinkedList([1, 2, 'ut oh', 3]);
    try {
      lst.average();
    } catch (e) {
      expect(e.message).toBe('Can only average number values!');
    }
  });
});
