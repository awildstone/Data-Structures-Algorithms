...
def add(square1, square2):
    ...
    #case single square
    if type(square1) == int and type(square2) == int:
        return 0 if (square1 == 0 and square2 == 0) else 1 
    
    #case single square and divided square - convert to divided squares
    if type(square1) == int:
    ...
    return [add(square1[i], square2[i]) for i in [0, 1, 2, 3]]
