...
describe("findRecursively", function() {
  ...
  it("returns undefined if a node is not found", function() {
    ...
    expect(foundNode).toBe(undefined);
    var foundNode2 = binarySearchTree.findRecursively(22);
    expect(foundNode2).toBe(undefined);
  }); 
});
...
describe("findSecondHighest", function() {
  it("finds the 2nd largest", function() {
    ...
    binarySearchTree3.insert(25);
    binarySearchTree3.insert(27);
    binarySearchTree3.insert(22);
    binarySearchTree3.insert(18);
    binarySearchTree3.insert(19);
    binarySearchTree3.insert(10);
    expect(binarySearchTree3.findSecondHighest()).toEqual(25);
  });
});
